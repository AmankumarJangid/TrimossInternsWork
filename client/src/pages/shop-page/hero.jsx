...
const HeroSection = () => {
  return (
    <section className="bg-white">
      <div className="py-20 sm:py-32 md:py-40 lg:py-48 flex items-center justify-center overflow-hidden">
        <h1 className="text-[60px] sm:text-[100px] md:text-[140px] lg:text-[200px] italic font-serif text-[#00263a]">
          Shop
        </h1>
      </div>

      <div className="h-auto py-10 flex items-center">
