      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-4">
          <div className="flex flex-col">
            <h3 className="text-white text-lg md:text-xl font-normal mb-4 md:mb-6 text-left">
              Featured Collections
            </h3>
            <h2 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-light leading-tight mb-6 md:mb-8 text-left">
              Wall Panels
            </h2>
          </div>
