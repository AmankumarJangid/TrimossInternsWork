  ...
  return (
    <section className="bg-white py-10 sm:py-14 md:py-20 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-10 md:gap-12 xl:gap-16">
          ...
          <div className="order-1 lg:order-2 flex flex-col text-left justify-center">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-semibold text-gray-900 leading-tight mb-6 sm:mb-8">
              Tables &<br />
              Furniture
            </h2>
            <div className="space-y-2 mt-6 sm:mt-10 md:mt-16 text-left">
              <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-light text-gray-900">
                Residential Projects
              </h3>
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-700 leading-relaxed max-w-lg">
